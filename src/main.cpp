...
int main() {
    ...
    while (running) {
        ...
        setup.myShader.setMat4("model", glm::value_ptr(cubeModel));
        myCube.Draw(setup.myShader);
        ...
        setup.myShader.setMat4("model", glm::value_ptr(pyramidModel));
        myPyramid.Draw(setup.myShader);
        ...
        setup.myShader.setMat4("model", glm::value_ptr(sphereModel));
        mySphere.draw(setup.myShader);
